          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "24px" }}>
            {sortiesSeniors.length > 0 ? (
              ...
              <div style={{ gridColumn: "1 / -1", textAlign: "center", padding: "60px 0", color: "#aaa" }}>
                <p style={{ fontSize: "16px", fontWeight: 600 }}>Aucune sortie programmée pour le moment.</p>
                <p style={{ fontSize: "14px", marginTop: "8px" }}>Revenez très vite pour découvrir notre nouvel agenda !</p>
              </div>
            )}
          </div>
        </div>
