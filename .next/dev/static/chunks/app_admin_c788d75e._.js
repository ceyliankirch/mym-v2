...
// ⚡ NOUVELLE FONCTION INTELLIGENTE POUR FORMATER LES DATES
const formatSejourDates = (startStr, endStr)=>{
    if (!startStr) return "À définir";
    const start = new Date(startStr);
    // S'il n'y a pas de date de fin, format simple
    if (!endStr) return start.toLocaleDateString("fr-FR");
    const end = new Date(endStr);
    // Si la date de début et de fin sont le même jour
...
//# sourceMappingURL=app_admin_c788d75e._.js.map