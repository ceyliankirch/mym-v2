...
const matchCategory = (s, cat)=>{
    ...
    if (cat === "seniors" && ageStr.includes("senior")) return true;
    if (cat === "ados" && (ageStr.includes("13") || ageStr.includes("14") || ageStr.includes("15") || ageStr.includes("16") || ageStr.includes("17"))) return true;
    if (cat === "enfants") return !ageStr.includes("senior") && !ageStr.includes("13") && ageStr !== "";
    return false;
};
/* ─── COMPOSANTS ─── */ function SejourCard({ s, idx }) {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                            src: s.imageUrl || "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800",
                            alt: s.titre,
                            style: {
                                width: "100%",
                                height: "100%",
...
function SejoursClient({ sejoursFromDb }) {
    ...
    const filtered = sejoursFromDb?.filter((s)=>s.statut === "Publié").filter((s)=>{
        return matchCategory(s, cat) && (!search || s.titre.toLowerCase().includes(search.toLowerCase()) || s.lieu?.toLowerCase().includes(search.toLowerCase()));
    }) || [];
                            ...
                            children: [
                                ...
                                "seniors"
                                    ...
                                    style: {
                                        ...
                                        fontWeight: 700,
                                        cursor: "pointer",
                                        background: cat === tab ? C.teal : "transparent",
                                        color: cat === tab ? "white" : C.teal,
                                        transition: "all .3s"
                                    },
                ...
                filtered.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            children: "Aucun séjour trouvé dans cette catégorie."
                        }, void 0, false, {
                            fileName: "[project]/app/sejours-enfants-ados/SejoursClient.jsx",
                            lineNumber: 150,
                            columnNumber: 13
...
//# sourceMappingURL=_55731ec1._.js.map