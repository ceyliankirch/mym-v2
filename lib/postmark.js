...
/* ─── NEWSLETTER / LISTE DE DIFFUSION ─────────────────────────────
   L'envoi des campagnes ne passe plus par Postmark : la liste de contacts
   est gérée ici (import/export CSV, tags) puis exportée vers Brevo, où
   les campagnes sont composées et envoyées manuellement. */
