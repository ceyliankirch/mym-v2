...
// 💳 Pré-inscription envoyée quand la famille a choisi de régler par carte bancaire :
...
export async function sendPreInscriptionEmail({
  ...
  const html = emailShell({
    ...
    bodyHtml: `
      ...
      ${montant ? footNote("Si vous avez déjà réglé le séjour, vous pouvez ignorer le bouton de paiement ci-dessus.") : ""}
    `,
  });
